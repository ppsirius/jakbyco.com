  ...
  render () {
    return (
      <div className="social-container">
        <div className="social-separator" ref="iconSeparator"></div>
        <div className="social">
          <a href="https://twitter.com/ppsirius" target="_blank" rel="noopener noreferrer" className="social-icon-container">
            <svg ref="iconTwitter" className="social-icon icon-twitter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37.5 31.2">
              <path fill="#FFF" d="M36.4.6c-1.5.9-3.1 1.6-4.9 1.9C30.1 1 28.1 0 25.9 0c-4.2 0-7.7 3.5-7.7 7.9 0 .6.1 1.2.2 1.8-6.4-.3-12-3.5-15.8-8.2-.7 1.2-1 2.5-1 4 0 2.7 1.4 5.1 3.4 6.6-1.3 0-2.4-.4-3.5-1v.1c0 3.8 2.6 7 6.2 7.7-.6.2-1.3.3-2 .3-.5 0-1 0-1.4-.1 1 3.1 3.8 5.4 7.2 5.5C8.9 26.7 5.6 28 2 28c-.6 0-1.2 0-1.8-.1 3.4 2.2 7.4 3.5 11.8 3.5 14.1 0 21.9-12 21.9-22.4V8c1.5-1.1 2.8-2.5 3.8-4.1-1.4.6-2.9 1.1-4.4 1.2C34.6 4 35.8 2.4 36.4.6z"/>
            </svg>
          </a>
          <a href="mailto:piotrek@jakbyco.com" target="_blank" rel="noopener noreferrer" className="social-icon-container">
            <svg ref="iconMail" width="18" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
              <path fill="#FFF" d="M9.732 8.485l4.95 4.242c-.18.168-.423.273-.69.273H2.008c-.268 0-.51-.103-.69-.27l4.95-4.245L8 10zM8 9L1.318 3.273c.18-.168.423-.273.69-.273h11.985c.268 0 .51.103.69.27zm7 3.186L10.167 8.08 15 3.874v8.31zm-14 0V3.878l4.833 4.2L1 12.187zm0 0"/>
            </svg>
          </a>
          <a href="www.linkedin.com/in/piotr-pupczyk" target="_blank" rel="noopener noreferrer" className="social-icon-container">
            <svg ref="iconLinkedin" className="social-icon icon-linkedin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36.9 33.5">
              <g fill="#FFF">
