    ...
    return (
      <div className="about">
        <div className="about-container">
          ...
          <div className="about-separator" ref="aboutSeparator"></div>
              ...
              <li className="about-info-element">
                <div className="hidden-text-container">
                  <div className="hidden-text" ref="place1">
                    ...
                    <svg className="about-info-icon marker" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 386.7 512">
                      <g>
              ...
              <li className="about-info-element">
                <div className="hidden-text-container">
                  <div className="hidden-text" ref="place2">
                    ...
                    <svg className="about-info-icon source-code" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                      <g>
              ...
              <li className="about-info-element">
                <div className="hidden-text-container">
                  <div className="hidden-text" ref="place3">
                    ...
                    <svg className="about-info-icon boxing" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                      <g>
        ...
        <div className="scroll-down" ref="scrollDown">
          <svg className="scroll-down-icon" ref="scrollDownIcon" xmlns="http://www.w3.org/2000/svg" viewBox="566.3 185.4 239.4 381.3">
            <g fill="none" stroke="#334455" strokeWidth="12" strokeMiterlimit="10">
              ...
              <path strokeLinecap="round" strokeLinejoin="round" d="M703.4 560.7h-34.7c-53 0-96.4-44.4-96.4-97.4V288.8c0-53 43.4-97.4 96.4-97.4h34.7c53 0 96.4 44.4 96.4 97.4v174.5c0 53-43.4 97.4-96.4 97.4z"/>
            </g>
          </svg>
        </div>
      </div>
